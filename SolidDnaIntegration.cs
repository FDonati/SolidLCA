...
namespace SolidLCA
{
    ...
    //        output dll file (for example /bin/Debug/SolidLCA.dll) and click Install.
    //
    ...
    public class MyAddinIntegration : AddInIntegration
    {
        ...
        public override void ConfigureServices(FrameworkConstruction construction)
        {
            ...
            // Add file logger (will be in /bin/Debug/SolidLCA.log.txt)
    ...
    public class MySolidDnaPlugIn : SolidPlugIn<MySolidDnaPlugIn>
    {
        ...
        /// My Add-in title
        /// </summary>
        public override string AddInTitle => "Solid-LCA Addin";

        /// <summary>
        /// My Add-in description
        /// </summary>
        public override string AddInDescription => "Create full Lifecycle Assessment and Lifecycle inventories for Solidworks projects";
        ...
        public override void ConnectedToSolidWorks()
        {
            ...
            // Application.ActiveModel.UnsafeObject.ConfigurationManager.Document.
        ...
        #region Disconnect from SolidWorks
